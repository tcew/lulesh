...
template class Allocator<occa::memory >;

template class Allocator<std::vector<float> >;
template class Allocator<std::vector<double> >;
template class Allocator<std::vector<int> >;
