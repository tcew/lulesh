...
/* #define occaTexture Real_t *occaRestrict */
/* #define occaTextFetch1D(a, id) a[id] */
...
/* 				    occaReadOnly occaTexture x, */
/* 				    occaReadOnly occaTexture y, */
/* 				    occaReadOnly occaTexture z, */
/* 				    occaReadOnly occaTexture xd, */
/* 				    occaReadOnly occaTexture yd, */
/* 				    occaReadOnly occaTexture zd, */
...
/* 	xn[i] = occaTextFetch1D(x, n[i]); */
/* 	yn[i] = occaTextFetch1D(y, n[i]); */
/* 	zn[i] = occaTextFetch1D(z, n[i]); */
/*       } */
...
/* 	  xdn[i] = occaTextFetch1D(xd, n[i]); */
/* 	  ydn[i] = occaTextFetch1D(yd, n[i]); */
/* 	  zdn[i] = occaTextFetch1D(zd, n[i]); */
/* 	} */
